...
namespace Q42.WinRT.SampleApp.Views
{
    ...
    /// </summary>
    public sealed partial class MainPage : Q42.WinRT.SampleApp.Common.LayoutAwarePage
    {
        public MainPage()
        {
        ...
        {
            NavFrame.Navigate(typeof(ConvertersExamplePage));
        }

        private void DataButton_Click_1(object sender, RoutedEventArgs e)
        {
            NavFrame.Navigate(typeof(DataExamplePage));

        }

        private void StorageButton_Click_1(object sender, RoutedEventArgs e)
        {
            NavFrame.Navigate(typeof(StorageExamplePage));
